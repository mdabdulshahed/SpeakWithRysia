...
function readoutput(message) {
  ...
  if (message.includes("hello") || message.includes("hi")) {
    ...
    var help = document.getElementById("options");
    help.style.display = "block";
    speech.text = "Commands which i can understand are listed below";
  } else if (message.includes("animation")) {
    speech.text = "";
    animate();
  }
  speech.volume = 1;
